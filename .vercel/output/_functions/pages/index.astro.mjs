...
` })} </div> </div> <!-- Logo ovale --> <div class="
    ...
    "> <img src="/src/assets/logoCMPlowerWavesColored.svg" alt="Logo waves" class="h-6 md:h-8 w-auto"> </div> <!-- Background image --> <img src="/src/assets/header.jpg" alt="Hero Image" class="absolute inset-0 w-full h-full object-cover object-center z-0"> </section>`;
