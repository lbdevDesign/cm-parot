import { e as createComponent, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, f as createAstro, m as maybeRenderHead, h as addAttribute, k as renderComponent, l as renderHead } from '../chunks/astro/server_A3fuUS7J.mjs';
import 'piccolore';
import 'clsx';
/* empty css                                 */
...
` })} </div> </div> <!-- Logo ovale --> <div class="
    ...
    "> <img src="/assets/logo/logoCMPlowerWavesColored.svg" alt="Logo waves" class="h-6 md:h-8 w-auto"> </div> <!-- Background image --> <img src="/assets/header.jpg" alt="Hero Image" class="absolute inset-0 w-full h-full object-cover object-center z-0"> </section>`;
